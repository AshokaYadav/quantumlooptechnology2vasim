export default function HowWeWork() {
    const steps = [
      ...
      },
      {
        ...
        title: "2. Strategy",
        description: "We plan and create a structured roadmap for execution."
      },
      {
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
        ...
        title: "3. Development",
        description: "Our expert team builds and tests your project efficiently."
      },
      {
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
        ...
        description: "We launch your project and provide continuous support."
      }
    ];
    ...
    return (
      <section className="py-20 px-5 md:px-10 bg-gradient-to-br from-gray-800 to-gray-900 text-white">
        <h2 className="text-4xl font-bold mb-16 text-center">
          How We <span className="text-green-400">Work</span>
        </h2>
